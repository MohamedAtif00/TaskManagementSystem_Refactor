...
- **Integration tests** — seed data from [`018_identity_SeedUsers.sql`](../src/Database/TaskManagementSystem.Database/Scripts/Migrations/018_identity_SeedUsers.sql) via [`IntegrationTestDataSeeder`](../tests/TaskManagementSystem.TestCommon/Integration/IntegrationTestDataSeeder.cs)
