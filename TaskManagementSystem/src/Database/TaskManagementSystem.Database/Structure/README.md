...
Initial bootstrap uses migrations `000`–`018` (including optional reference data in `010_seeds_ReferenceData.sql`). Additional seeds live under `Scripts/Seeds/` for manual use (`002_IntegrationTestData.sql` mirrors `018_identity_SeedUsers.sql`).
