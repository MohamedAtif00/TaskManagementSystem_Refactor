-- Source of truth for notifications.Notifications
-- Deployed via Scripts/Migrations/008_notifications_Tables.sql
-- Column repair for stub tables: Scripts/Migrations/026_notifications_Notifications_Columns.sql
