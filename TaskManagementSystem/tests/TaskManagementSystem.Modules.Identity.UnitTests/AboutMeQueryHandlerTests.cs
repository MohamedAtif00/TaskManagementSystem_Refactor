...

{
...

    {
        ...
        var aboutMeQueries = Substitute.For<IAboutMeQueries>();

        aboutMeQueries.GetAsync(42, Arg.Any<CancellationToken>())
        ...
        unitOfWork.AboutMe.Returns(aboutMeQueries);
...

    {
        ...
        aboutMeQueries.GetAsync(99, Arg.Any<CancellationToken>())
