...
public class AuthService : IAuthService
{
	...
	public async Task<ActionResult<ResponseService<string>>> Login(string Code, HttpResponse response)
	{
		var user = await _context.Users
			.Where(u => u.Code.ToLower() == Code.ToLower())
			.FirstOrDefaultAsync();
	...
	public async Task<ActionResult<BaseResponseService>> Logout(HttpRequest request, HttpResponse response)
	{
	...
	public async Task<ActionResult<ResponseService<string>>> RefreshToken(HttpRequest request, HttpResponse response)
	{
		var refreshToken = request.Cookies["refreshToken"];
