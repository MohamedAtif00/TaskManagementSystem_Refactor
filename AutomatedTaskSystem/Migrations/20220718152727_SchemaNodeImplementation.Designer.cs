...
namespace AutomatedTaskSystem.Migrations
{
    ...
    [Migration("20220718152727_SchemaNodeImplementation")]
    partial class SchemaNodeImplementation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NodeNode", b =>
                {
                    b.Property<int>("NextNodesId")
                        .HasColumnType("int");

                    b.Property<int>("PreviousNodesId")
                        .HasColumnType("int");

                    b.HasKey("NextNodesId", "PreviousNodesId");

                    b.HasIndex("PreviousNodesId");
            ...
            modelBuilder.Entity("NodeNode", b =>
                {
                    b.HasOne("AutomatedTaskSystem.Models.Node", null)
                        .WithMany()
                        .HasForeignKey("NextNodesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutomatedTaskSystem.Models.Node", null)
                        .WithMany()
                        .HasForeignKey("PreviousNodesId")
