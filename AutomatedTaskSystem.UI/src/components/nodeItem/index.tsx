                    ...
                    <div className="flex gap-2 items-center">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div
                                ...
                                onClick={() =>
                                    API.SCHEMAS.NODES.DOWN(id).then(
                                        (res) => res && updateNodes()
                                    )
                                }
                            >
                ...
                {auth.role == 1 ? (
                    <>
                        <div className="flex gap-2 pr-2">
                            <div
                                onClick={() =>
                                    API.SCHEMAS.NODES.STEPS.UP(id).then(
                                        (res) =>
                                            res && !res.error && updateNodes()
                                    )
                                }
                            >
                                <svg
                            ...
                            <div
                                className="rotate-180"
                                onClick={() =>
                                    API.SCHEMAS.NODES.STEPS.DOWN(id).then(
                                        (res) =>
                                            res && !res.error && updateNodes()
                                    )
                                }
                        ...
                        <Link
                            className="px-2 rounded hover:bg-red-600 hover:text-white text-red-600"
                            href={{
                                pathname: router.asPath,
                                query: {
                                    form: "delete-step",
