    ...
    return (
        <div>
            <div
                ...
                className="cursor-pointer h-10 text-sm flex items-center justify-between pr-8"
            >
                <div>{name}</div>
            ...
            {toggle && (
                <div className="text-sm pl-4 cursor-default">
                    <div className="border-slate-300 border-solid border-l">
                        {learningObjectives.map((lo) => {
                            ...
                            return (
                                <div
                                    className="px-4 flex justify-between items-center border-solid border-slate-300 py-2"
                                    key={lo.id}
                                >
                                    {ed ? (
