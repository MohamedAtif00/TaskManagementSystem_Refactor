...
const TeamLeaderDashboard = () => {
    ...
    const { name } = useAppSelector((s) => s.authSlice);
    ...
    const displayName = name?.split(" ")[0] ?? "Team Leader";
    ...
    return (
        <div className="min-h-screen text-[#29313D] p-6 pl-8">
            ...
            <DashboardHeader
                title="Dashboard"
                subtitle={`Welcome back, ${displayName}! Let's manage the team's sprint progress.`}
            />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
                <div className="bg-white rounded-xl p-6 border border-gray-100">
                    ...
                    <div className="flex flex-col gap-3">
                        {dashboard.membersWorkload.length === 0 ? (
                            <p className="text-sm text-gray-400">No members</p>
                        ) : (
                            dashboard.membersWorkload.map((member, index) => (
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-100 max-h-[311px] overflow-hidden">
                    ...
                    <div className="flex flex-col gap-3">
                        {dashboard.flaggedRollbackTasks.length === 0 ? (
                            <p className="text-sm text-gray-400">No flagged or rollback tasks</p>
                        ) : (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mt-0.5">
                                            {task.type === "flagged" ? "Flagged" : "Rollbacked"} ·{" "}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <div className="lg:col-span-2 bg-white rounded-xl p-6 border border-gray-100 max-h-[311px] overflow-hidden">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-bold text-gray-800">Sprints Overview</h3>
                        <Link
                            href="/sprints"
                            className="text-sm text-blue-600 hover:underline font-medium"
                        >
                    ...
                    <div className="flex flex-col gap-4">
                        {dashboard.activityLog.length === 0 ? (
                            ...
                            dashboard.activityLog
                                ...
                                >
                                    <div
                                        className="w-8 h-8 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center text-xs font-bold shrink-0"
                                    >
                                        {activity.initials}
                                    </div>
