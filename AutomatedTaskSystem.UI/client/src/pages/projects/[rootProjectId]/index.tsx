...
import AddYear from "../../../components/pageComponent/projects/addYear";
import EditYear from "../../../components/pageComponent/projects/editYear";
    ...
    return (
        <>
            <HierarchyListPage
                ...
                addLabel="Add Year"
                addHref={{
                    pathname: `/projects/${rootProjectId}`,
                    query: { form: "add-year" },
                }}
                rows={years.map((y) => ({
                    id: y.id,
                ...
                columns={yearColumns}
                rowHref={(yearId) => `/projects/${rootProjectId}/years/${yearId}`}
                editHref={(id) => ({
                    pathname: `/projects/${rootProjectId}`,
                    query: { form: "edit-year", yearId: id },
                })}
            />
            <AddYear />
            <EditYear />
...
export default ProjectYearsPage;
